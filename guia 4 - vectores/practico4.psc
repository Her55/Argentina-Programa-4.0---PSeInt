Algoritmo practico4
	...
	Repetir			
		...
		Escribir "E. Menu para mostrar los vectores: A, B o C"
		escribir "F. Salir."		
		leer opciones			
		Segun Mayusculas(opciones)
			...
			"C":
				si a=Verdadero y b=Verdadero	
					...
					Borrar Pantalla
					escribir "El vector C se lleno correctamente con la suma de los elementos"
					escribir ""
					c=1
				SiNo
					si a=Verdadero y b=falso
						Borrar Pantalla
						escribir "Falta llenar el vector B"
						escribir ""
					SiNo
						Borrar Pantalla
						escribir "Falta llenar el vector A"
						escribir ""
					FinSi					
				FinSi
			"D":
				si a=Verdadero y b=Verdadero				
					...
					Borrar Pantalla				
					escribir "El vector C se lleno correctamente con la resta de los elementos"
					escribir ""
					c=2
				SiNo
					si a=Verdadero y b=falso
